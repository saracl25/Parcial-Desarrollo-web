...
## Alcance y funcionalidades iniciales
...
### 1. Pantalla de Inicio y Navegación Principal
...
### 2. Gestión y Selección de Destinos
El usuario puede ingresar o seleccionar un destino guardado (como la universidad, casa o fundaciones aliadas) mediante búsqueda de texto o dictado por voz para recibir indicaciones de mapeado y orientación en trayectos cotidianos.

![Selección de Destinos y Rutas](images/rutas.png)

---

### 3. Orientación en Tiempo Real
El usuario recibe alertas y orientaciones auditivas y visuales en tiempo real durante sus desplazamientos urbanos (giros indicados en metros, avisos de semáforos sonoros y cruces peatonales).

![Orientación en Tiempo Real](images/navegacion.png)

---

### 4. Asistencia por Voz y Ajustes de Audio
El usuario puede activar y personalizar el sistema de conversión de texto a voz (TTS), ajustando la velocidad de lectura, el volumen de la guía, la voz elegida (Clara, Neutral, Grave) y las lecturas automáticas de nombres de calles y entornos cercanos.

![Ajustes de Voz y Audio](images/voz_audio.png)

---

### 5. Configuración de Perfil y Red de Apoyo
El usuario puede configurar su perfil de accesibilidad (por ejemplo, modo baja visión con contraste alto y texto ampliado), vincular contactos principales de su red de apoyo y tener acceso directo a líneas de emergencia.

![Configuración de Perfil](images/perfil.png)

---

## Mockup Completo

![Mockup Completo del Proyecto CYLONS](images/image1.png)

### Galería de Pantallas

| Inicio | Rutas y Destinos | Navegación en Vivo | Voz y Audio | Perfil de Usuario |
| :---: | :---: | :---: | :---: | :---: |
| ![Inicio](images/inicio.png) | ![Rutas](images/rutas.png) | ![Navegación](images/navegacion.png) | ![Voz y Audio](images/voz_audio.png) | ![Perfil](images/perfil.png) |
